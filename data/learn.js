export const learnGuides = [
  {
    ...
    content: `
      ...
      <p>Source ADR and occupancy from comparable listings with the same bedroom count, similar amenities, and a similar location. Our guide on <a href="/learn">reading AirDNA data</a> covers how to pull comps responsibly.</p>
      ...
      <p>Debt service is your annual mortgage payments (principal and interest). Use a real rate quote for your loan type. See <a href="/learn">financing options compared</a> for how loan types differ.</p>
      ...
      <ul>
        ...
        <li><strong>Ignoring regulation.</strong> A deal that is not legal to operate has no revenue. Check the <a href="/learn">permits and zoning checklist</a> first.</li>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Monthly views reveal peaks and troughs. A market that earns most of its income in three months carries more risk than one with steadier demand. Pair this with our <a href="/learn">seasonality planning guide</a>, and check whether your cash reserves can cover slow months.</p>
      ...
      <ul>
        <li><strong>Comparing gross revenue to your profit.</strong> Revenue is not income. Subtract expenses using the framework in <a href="/learn">STR underwriting basics</a>.</li>
  ...
  },
  {
    ...
    content: `
      ...
      <ol>
        ...
        <li><strong>Financing.</strong> Many conventional loans are made to individuals. Moving a property into an LLC after closing can trigger issues with the loan terms, so ask your lender before transferring title. Some loan programs lend directly to entities. See <a href="/learn">financing options compared</a>.</li>
        ...
        <li><strong>Licenses and permits.</strong> Some jurisdictions issue permits to a person or entity and may restrict transfers. Check requirements in the <a href="/learn">permits and zoning checklist</a>.</li>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Most jurisdictions require lodging or occupancy tax registration. See <a href="/learn">occupancy tax basics</a>. This is a compliance topic, separate from any income tax planning.</p>
      ...
      <p>The <a href="/learn">due diligence checklist</a> pairs well with this one, and our <a href="/markets">markets pages</a> offer starting context, though you should always verify current local rules.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Tie the final cost back into your <a href="/learn">underwriting model</a> so you see net cash flow, not just the fee line.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        ...
        <li>Entity structure, if borrowing through an LLC (see <a href="/learn">our legal structure guide</a>)</li>
      </ul>
      ...
      <p>Pair this with <a href="/learn">down payment strategies</a> to plan cash needs.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <ol>
        <li><strong>Down payment.</strong> Set by the loan program (see <a href="/learn">financing options compared</a>).</li>
        ...
        <li><strong>Furnishing and setup.</strong> Furniture, bedding, kitchen, décor, technology. See the <a href="/learn">furnishing checklist</a> and our <a href="/blog/airbnb-furnishing-budget-guide">furnishing budget guide</a>.</li>
      ...
      <p>New listings often take time to build reviews and rankings. Underwrite a slower first few months, and hold reserves to cover them. Our <a href="/learn">cash flow forecasting guide</a> shows how to model this.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Check the <a href="/learn">permits and zoning checklist</a> for local requirements.</p>
      ...
      <p>Then move on to <a href="/learn">amenities that drive bookings</a>.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>See also <a href="/learn">listing photos and copy</a> for showing amenities well.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Also see <a href="/learn">guest screening and house rules</a> and <a href="/learn">maintenance reserve planning</a>.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Use monthly revenue, occupancy, and ADR from your data source (see <a href="/learn">how to read AirDNA data</a>) and speak with local managers. Identify:</p>
      <ul>
        <li>Peak months</li>
      ...
      <p>Hold operating reserves separate from repair reserves; see <a href="/learn">maintenance reserve planning</a>.</p>
      ...
      <ul>
        ...
        <li>Review the ideas in <a href="/learn">revenue management basics</a>.</li>
      </ul>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Ask who is responsible for registration, collection, and filing, and get the answer in writing in the management agreement. Confirm whose account number is used and how you can verify that filings are made. The <a href="/learn">management fees guide</a> lists other contract points to check.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>See <a href="/learn">listing photos and copy</a> for writing and photo advice.</p>
      ...
      <p>Listings that show availability at reasonable prices in relation to comparable listings tend to attract more views and bookings. A calendar full of blocks or an unusually high price can hurt conversion. Revisit pricing using the process in <a href="/learn">revenue management basics</a>.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <ol>
        <li>Finish furnishing and styling before the shoot (see <a href="/learn">the furnishing checklist</a>).</li>
      ...
      <p>Update photos after renovations, seasonal changes, or new amenities. Consider seasonal images such as snow or summer outdoor shots if your market is seasonal (see <a href="/learn">seasonality planning</a>). Track views and conversion after changes, changing one thing at a time, as described in <a href="/learn">listing SEO on Airbnb</a>.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <ol>
        ...
        <li>Record the target balance in your underwriting model (see <a href="/learn">underwriting basics</a>).</li>
      </ol>
      <p>Keep it separate from your seasonal operating reserve described in <a href="/learn">seasonality planning</a>.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        ...
        <li>How does coverage work if I own the property through an LLC (see <a href="/learn">legal structure basics</a>)?</li>
      ...
      <ul>
        ...
        <li>Regular inspections and maintenance (see <a href="/learn">maintenance reserve planning</a>)</li>
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        <li>Confirm short-term rentals are allowed on the parcel (see the <a href="/learn">permits and zoning checklist</a>).</li>
        ...
        <li>Confirm lodging tax registration needs (see <a href="/learn">occupancy tax basics</a>).</li>
      </ul>
      ...
      <ul>
        ...
        <li>Age and remaining life of major systems (feed this into <a href="/learn">reserve planning</a>)</li>
      ...
      <ul>
        ...
        <li>Rebuild your underwriting with verified numbers (see <a href="/learn">underwriting basics</a>).</li>
        <li>Confirm loan terms and rate lock, and any conditions related to rental income.</li>
      </ul>

      <h2>Part 4: Market and revenue</h2>
      <ul>
        <li>Pull current comps and cross-check estimates (see <a href="/learn">reading AirDNA data</a>).</li>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Hire or change a manager if you want to keep the asset but reduce involvement. Review contract terms and listing ownership (see <a href="/learn">management fees explained</a>).</p>
      <h3>6. Partner buyouts or transfers</h3>
      <p>If you own with partners, an operating agreement should describe how one can buy out another (see <a href="/learn">legal structure basics</a>).</p>
  ...
  },
  {
    ...
    content: `
      ...
      <ol>
        ...
        <li><strong>Standardized property setup:</strong> similar furnishings, smart locks, and supplies, so vendors and stock are interchangeable (see <a href="/learn">furnishing checklist</a>).</li>
      ...
      <p>Each property needs its own down payment, furnishing, and reserves (see <a href="/learn">down payment strategies</a>). Lenders also look at your overall debt and property count, and some programs limit the number of financed properties. Ask lenders in advance how a growing portfolio affects qualification (see <a href="/learn">financing options</a>).</p>
      ...
      <ul>
        ...
        <li><strong>Hire a manager for some or all properties:</strong> simplifies operations, costs a percentage (see <a href="/learn">management fees explained</a>).</li>
      ...
      <p>Compare the trade-offs of diversification with the learning benefits of staying in one market, and use the <a href="/learn">market selection framework</a> when considering a new area.</p>
      ...
      <ol>
        ...
        <li>The deal passes underwriting and due diligence (see <a href="/learn">due diligence checklist</a>).</li>
      </ol>
  ...
  },
  {
    ...
    content: `
      ...
      <ol>
        <li>Read the ordinances and speak with the local planning office (see <a href="/learn">permits and zoning checklist</a>).</li>
        <li>Pull revenue, occupancy, ADR, and supply data (see <a href="/learn">how to read AirDNA data</a>).</li>
      ...
      <p>Take two or three real listings in each top market and run the model in <a href="/learn">STR underwriting basics</a>, including stress tests. If the deals fail the stress test in a market, the score should reflect that.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Use ADR, occupancy, and days in each month (see <a href="/learn">revenue management basics</a> and <a href="/learn">seasonality planning</a>). Include a ramp-up for a new listing: first months at lower occupancy while reviews build.</p>
      ...
      <p><strong>Variable costs</strong> move with bookings: cleaning, laundry, supplies, platform fees, management percentage, and occupancy taxes collected (track them as pass-through, not income; see <a href="/learn">occupancy tax basics</a>).</p>
      ...
      <p>Enter the mortgage payment monthly. Add a monthly transfer to the maintenance reserve (see <a href="/learn">maintenance reserve planning</a>). Keep the operating cash balance visible.</p>
      ...
      <p>Use the outputs to test ideas from <a href="/learn">underwriting basics</a>, and revisit them whenever assumptions change.</p>
